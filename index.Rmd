...
# Enough R to write a thesis {.unnumbered}
...
```
### <a class = "book" href = "workingInR/index.html">Working in R</a> {.unnumbered}
...
### <a class = "book" href = "rmarkdown/index.html">Reproducible documents with R</a> {.unnumbered}
...
### <a class = "book" href = "github/index.html">Git and GitHub</a> {.unnumbered}
...
### <a class = "book" href = "package/index.html">Writing an R package</a> {.unnumbered}
...
## Biostats apps and tutorials {.unnumbered}
