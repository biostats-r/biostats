...
library(ggplot2)
```
A regular scatter plot represents with dots (or any other symbols) the relationship between two given variables. But one can plot a third variable to any scatter plot by the mean of a gradient of colors applied onto the dots.
