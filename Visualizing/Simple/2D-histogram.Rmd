...
Letâs take the following example where the variable to be plotted along the X-axis (`values1`) and the variable to be plotted along the Y-axis (`values2`) both contain 4000 points (!). Here are the variables and the dataframe:
```{r dataframe}
# variable 1
