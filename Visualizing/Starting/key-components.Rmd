...
Here we omit the function `geom_point()`. `ggplot()` is left with the dataframe and the æsthetics, but it does not know what to do with it. As a result, it shows you the axes, scales, grid and background, but nothing more:
