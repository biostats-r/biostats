...
WEB <- c("https://bioceed.uib.no/dropfolder/bioSTATS/Rmd/Basic/Visualizing/Faceted/grid-clustered-boxplots.html")
GIT <- c("https://github.com/jonathansoule/biostats/blob/master/Basic/Faceted/Faceted/grid-clustered-boxplots.Rmd")
library(ggplot2)
library(gridExtra)
