...
WEB <- c("https://bioceed.uib.no/dropfolder/bioSTATS/Rmd/Basic/Visualizing/Essential/category-labels.html")
GIT <- c("https://github.com/jonathansoule/biostats/blob/master/Basic/Visualizing/Essential/category-labels.Rmd")
library(ggplot2)
