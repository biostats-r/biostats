...
WEB <- c("https://bioceed.uib.no/dropfolder/bioSTATS/Rmd/Basic/Visualizing/Essential/color-scale-continuous.html")
GIT <- c("https://github.com/jonathansoule/biostats/blob/master/Basic/Visualizing/Essential/color-scale-continuous.Rmd")
library(ggplot2)
library(gridExtra)
# variable 1
...
```{r gradient, fig.width=10, fig.height=4}
grid.arrange(
  ggplot(df, aes(values1, values2)) +                       
    geom_point(aes(color = values3), size = 2) +
