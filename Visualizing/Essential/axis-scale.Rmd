...
WEB <- c("https://bioceed.uib.no/dropfolder/bioSTATS/Rmd/Basic/Visualizing/Essential/axis-scale.html")
GIT <- c("https://github.com/jonathansoule/biostats/blob/master/Basic/Visualizing/Essential/axis-scale.Rmd")
library(ggplot2)
library(gridExtra)
