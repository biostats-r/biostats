...
WEB <- c("https://bioceed.uib.no/dropfolder/bioSTATS/Rmd/Basic/Visualizing/Essential/axis-title.html")
GIT <- c("https://github.com/jonathansoule/biostats/blob/master/Basic/Visualizing/Essential/axis-title.Rmd")
library(ggplot2)
```
