...
You need to be familiar with different types of data (continous, categorical) and handle tibbles.
...
There are many different ways of visualizing data, but there are some rules that apply in general.
...
Each other component of the plot is added with `+`, and you can think of different layers that are put on top of each other.



## The Palmer Penguin Example

We will mostly work with the Palmer Penguine data set (Allison Horst, REF).
...
Now we will describe the different components a plot is made of.

### Data
To make a plot we use the function `ggplot()`.
The first element in this function is the **data object** containing all the variables that you need to make a plot.
