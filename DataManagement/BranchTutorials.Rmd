...
**Merge conflicts** can easily be avoided if you keep your **branches** separate for each file.
...
```
<br/><br/>
Save the file, **commit**, switch to the **main branch**, **merge** and **push** to GtiHub.
