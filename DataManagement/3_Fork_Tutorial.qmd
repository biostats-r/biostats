...
You can work the way it is described in section \@ref(stage-commit-and-push).
...
If you have forked a repo it will also show you the **upstream** repo (see \@ref(collaborating-with-forks) Collaborating with forks and branches tutorial for more details).
