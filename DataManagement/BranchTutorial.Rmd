...
### Fork repo (on github)
Go to Github, login and go to the repository you want to fork. Click on the fork button on the top right of the page. A new window will appear and you can give the forked repository a new name.
...
```{r name branch, echo=FALSE, out.width = '50%'}
