...
Therefore, when collaborating with others, you always work on **branches**, and then you make a **pull requests** by **merging** the changes in the **current branch** to the **main branch** (see \@ref(make-pull-request-in-github)). 
...
A **merge conflict** can occur when two people are changing the same line in one file differently.
!!! Add instructions for how to deal with this!!!

<br/><br/>

**Prevent from pushing to main**

!!! Explain why and how to lock master branch.
