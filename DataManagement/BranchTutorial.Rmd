...
If you are **collaborating** with other people you do not want to merge with the main branch. This is when **pull requests** come in handy (see \@make-pull-request-in-github). 
...
The **maintainer** of the original repository has to evaluate your changes to the project and can accept your changes, suggest changes for improvement or decline.
