...
Working in git is not painless and sometimes things will go wrong. Don't panic, there is a solution for your problem.
...
Working on the master branch summons zombies...

But there is a solution to prevent yourselve from commiting to master.
Type the following and the next time you forget to make a new branch and commit it will tell you not to.
