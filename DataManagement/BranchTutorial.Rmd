...
Once you have pushed your branch back to the master branch you can make a pull request. Go back to Github, to the forked repository. A green box appears at the top of the page "pull requst". Click on this box and your will get to the original repository.
Now it's time for you to relax, have a cake you have earned it 🍰
<br/><br/>

### Master accepts pull request (or not)
Now it's time for the owner of the original project to evaluate your changes to the project. The owner can accept your code, decline or make suggestions for improvement.
```{r accept pull request, echo=FALSE, out.width = '100%'}
#knitr::include_graphics("Pics/10. make file.png")
```
<br/><br/>

### Update your fork (Terminal)
In RStudio open up the terminal:
