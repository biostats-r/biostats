...
If there are existing files, you might want to pick which files are committed (see section \@ref(stage-commit-and-push)) and improve the `.gitignore` (see section \@ref(gitignore-file)).
