...
Here we will focus on the statistical programm R.
On GitHub you can make repositories, which is a kind of project.
Your repository, or short repo, is online on GitHub and called remote.
To work on the repository, you need to clone it locally onto your computer.
On your computer you can write and develop R code, you then commit the new code and push it back remotely, and GitHub keeps track of all the changes you have made.
...
Click on the green clone Git Respository button and copy the Respository URL.
<br/><br/>
```{r clone}
...
<br/><br/>
<br/><br/>
Enter the project directory name, paste the url link from above and create the project.
<br/><br/>
...
Go to Github and create a new repository (see above).
...
<br/><br/>
Restart Rstudio.
If it worked you can see the git panel with a green and blue arrow to push and pull.

!!! ADD FIGURE OF GIT PANEL!!!
...
If you create or edit a file in your repository and save the chages the file will turn up in the git panel labelled with two yellow question marks.

!!! Picture of git window !!!
...
!!! picture of green and red lines !!!
...
At this stage, all code and changes are still locally stored on your computer. 
To upload your commits to your remote GitHub repository you need to push (green arrow) these changes to your remote repository on GitHub.

!!! picture of gir window and green arrow !!!

## Share a repository

!!! picture of 2 people working on same repo !!!
