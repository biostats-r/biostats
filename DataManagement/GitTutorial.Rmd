...
!!! INTRODUCE KINGSLEY AND ANGELINA !!!
...
Mac users also need the software xcode)
...
The **Project directory name** will automatically the repo name.
...
!!! SHOULD BE A PICTURE WITH LOTS OF YELLOW FILES!!!
<br/><br/>
```{r git_window}
