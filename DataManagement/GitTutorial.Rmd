...
This workflow is useful if you already have an RStudio project or are starting a new project.

Start by creating a git repo for your project with 
...
If there are existing files, you might want to pick which files are committed (see \ref(stage-commit-and-push)) and improve the `.gitignore` (see \ref(.gitignore-file)).
