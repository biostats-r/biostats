...
To **fork** a repo, go to GitHub, log into your account (see section \@ref(preparation) for how to make an GitHub account) and go to the repository you want to **fork**
...
#### Excercise: fork a repo on GitHub

Now it is your time to **fork** a repo.
Go to the magic_dragons repo on biostats https://github.com/biostats-r/magic_dragons and **fork** the repo following the instructions above
You need to have a GitHub account (see section \@ref(preparation) for how to make an GitHub account).

You should now have a repo in your GitHub account called magic_dragons.
We will later in this tutorial use the forked repo to make a pull request.



### Clone a forked GitHub repository

To clone a forked repo, go to GitHub.
On the top of the page is the name of the **forked repository** and the project name.
Click on the green **Code** button on the top right, make sure you are on the **SSH** tab and copy the url link.
...
In case you have made a typo or something else is wrong with your **upstream repo** you first need to remove upstream before you can add or change it.
Here is the command to remove upstream:
