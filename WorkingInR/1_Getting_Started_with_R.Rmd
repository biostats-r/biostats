...
You must have successfully turned on your PC, Mac or Linux machine. 
...
Go to the website [cloud.r-project.org](https://cloud.r-project.org/) and choose on which platform you wish to install R. Then download the package and install it as any other software.
...
In the **chunks** in the Rmarkdown files, the underscore should be replaces with a dash:
```{r download-git}```
