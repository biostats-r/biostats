...
If you already have these installed, check that the R version is 4.2 or newer (run `R.version.string`) and the RStudio version is 2022.07.1 or newer (run `rstudioapi::versionInfo()$long_version`).
:::
