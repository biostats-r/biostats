...
#| fig-alt: Screenshot of RStudio showing the environment and tutorials tab in the top right pane
#| out-width: "100%"
...
#| fig-alt: Screenshot of the RStudio tutorial tab showing links to three tutorials from the biostats.tutorials package
#| out-width: "100%"
...
There are alternatives to RStudio, which may be useful if RStudio won't work on your computer, or you want to try something else.

- [Positron](https://positron.posit.co/) is a fork of VScode developed by posit (the same company that makes RStudio). 
The main [advantage](https://positron.posit.co/migrate-rstudio-compare.html) of positron is that you can also it for coding Python and other languages.
