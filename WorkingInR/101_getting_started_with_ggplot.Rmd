...
See chapter \@ref(choosing-your-visualisation) for an overview.
...
In other words you can manually change the axis text, labels, ticks, add breaks, make transformations, and manipulate aesthetics like colour, shape, linetype (see section \@ref( colours-shapes-and-linetypes)).
...
See chapter \@ref(themes) for more about using themes.
...
```
 ...
 <details>
  <summary>Hint</summary>
Use `colour = species` and `scale_colour_viridis_c()`, not `fill`
</details> 
...
Further you can learn the most common plots types that are commonly used  (\@ref(choosing-your-visualisation)).
