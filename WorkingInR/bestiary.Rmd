...
Double colons `::` are used to 

Triple colons `:::` are used
...
Dots are commonly used in function names ...
...
In Rstudio you can use the keyboard shortcut `ctrl-shift-c` to comment or uncomment multiple lines of code at the same time.
