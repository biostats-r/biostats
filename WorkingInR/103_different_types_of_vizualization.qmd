...
#| fig-height: 3
#| fig-width: 3
#| fig-alt: A barplot showing the number of each species of penguin.
...
#| fig-height: 3
#| fig-width: 3
#| fig-alt: A barplot showing the number of penguins.
penguins |>
  count(species) |>
...
#| message: false
#| fig-keep: none
base <- ggplot(penguins, aes(x = flipper_len))
...
```{r}
#| label: hist-density-patch
#| echo: false
#| fig-height: 5
#| fig-width: 7
#| fig-alt: >
#|   A histogram (left) and a density plot (right) of penguin flipper length.
...
#| message: false
#| fig-keep: none
base <- ggplot(penguins, aes(x = flipper_len, fill = species))
p_hist <- base + geom_histogram()
...
```{r}
#| label: boxplots-etc
base <- ggplot(penguins, aes(x = species, y = flipper_len))
...
#| echo: false
#| fig-alt: >
#|   Six alternative plots for showing a few distributions of continuious
#|   variables.
...
#| fig-height: 4
#| fig-width: 4
#| fig-alt: Violin plot of penguin flipper length, coloured by sex.
penguins |>
  drop_na(flipper_len, sex) |>
  ggplot(aes(x = species, y = flipper_len)) +
  geom_violin(aes(fill = sex))
```

Need to decide which variable to have on the x-axis and which to have as fill.
You can also use facets with more complex plots.
...
#| fig-width: 5
#| fig-alt: >
#|   A 2-d density plot of penguin bill depth against bill length,
#|   coloured by species.
ggplot(data = penguins, aes(x = bill_len, y = bill_dep, colour = species)) +
  geom_density2d()
```
...
#| message: false
#| fig-alt: >
#|   A matrix of plots showing the relationships between all pairs of variables.
library(GGally)
penguins |>
  select(-year) |>
...
#| eval: true
#| fig-alt: >
#|   A heatmap of correlations between different variables in 
#|   the penguin dataset.
...
```{r}
#| label: heatmap-circles
#| eval: true
#| fig-alt: >
#|   An alternative version of the heatmap, showing circles scaled 
...
#| label: lines
#| eval: true
#| fig-alt: Line plot showing unemployment between 1970 and 2015.
