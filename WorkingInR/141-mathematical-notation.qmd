...
#| label: expression1
#| fig-alt: >
#|   Plot of a quadratic relationship with a simple expression for the x-axis.
# sample data
dat <- tibble(x = 1:5, y = x^2)
...
#| label: expression2
#| fig-alt: > 
#|   A copy of the previous plot with an expression that includes a space.
...
#| label: expression3
#| fig-alt: >
#|   A copy of the previous plot with an expression that includes a
#|   Greek symbol.
...
#| label: expression4
#| fig-alt: >
#|   A copy of the previous plot with an expression that includes
#|   superscript text.
...
#| label: expression5
#| fig-alt: >
#|   A copy of the previous plot with an expression that begins with
#|   superscript text.
...
#| fig-alt: >
#|   Barchart showing the chemical composition of Lake Aranguadi.
#|   Chemical formulae are given on the x-axis and above each bar.
#| fig-height: 5
#| fig-width: 7
