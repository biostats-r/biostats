...
It is possible to use copilot with Rstudio if you have a [GitHub](https://github.com) account. 
Copilot is free if you have a [verified student account](https://github.com/education/students).
