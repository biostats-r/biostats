...
```{r, echo = FALSE, fig.cap = "The default theme, `theme_grey()`", fig.height=3, fig.width=4}
p1 + theme_grey()
```
...
```{r, echo = FALSE, fig.cap = "Various themes from `ggplot2` and `gthemes`."}
library(ggthemes)
library(patchwork)
bs <- 8
...
I do this in the setup chunk of R markdown documents.
