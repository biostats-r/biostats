...
The code for to make a scatterplot with the `penguins` dataset looks something like this:
...
#| fig-width: 3.5
#| fig-alt: >
#|   Scatterplot of penguin bill length against body mass, coloured by species.
ggplot(data = penguins,
       mapping = aes(x = body_mass, y = bill_len, colour = species)) +
  geom_point() +
...
#| fig-alt: >
#|   Schematic showing how ggplot figures are built from different layers.
#| out-width: '100%'
...
#| fig-width: 3
#| fig-alt: >
#|   The blank canvas ggplot figures start with before adding aesthetics and
#|   geometries.
ggplot(data = penguins)
...
#| fig-height: 3
#| fig-width: 3
#| fig-alt: A ggplot without any geometries
...
p1 <- ggplot(penguins, aes(x = bill_len, y = bill_dep, colour = species)) +
  geom_point()
p2 <- ggplot(penguins, aes(x = bill_len, y = bill_dep, colour = species)) +
  geom_density2d()
p3 <- ggplot(penguins, aes(x = species, fill = island)) +
  geom_bar()
p4 <- ggplot(penguins, aes(x = species, y = bill_dep, fill = species)) +
  geom_boxplot()
...
#| echo: false
#| warning: false
#| fig-alt: ggplot figures with a selection of geometries
library(patchwork)
...
#| fig-width: 3.5
#| fig-alt: > 
#|   Scatterplot of bill length against bill depth with scales used to modify
#|   axes and colour scales.
ggplot(penguins, aes(x = bill_len,
                     y = bill_dep,
                     colour = species)) +
  geom_point() +
...
#| fig-height: 3
#| fig-width: 3.5
#| fig-alt: Scatterplot with axis labels and title.
ggplot(penguins, aes(
  x = bill_len,
  y = bill_dep,
  colour = species
...
#| fig-width: 5
#| fig-alt: >
#|   Scatterplot of penguin bill depth against bill length, coloured by species,
#|   faceted by island.
ggplot(penguins, aes(x = bill_len,
                     y = bill_dep,
                     colour = species)) +
...
#| fig-width: 5
#| fig-alt: > 
#|   Scatterplot faceted by island, using theme to change the size and
#|   colour of text.
ggplot(penguins, aes(x = bill_len,
                     y = bill_dep,
                     colour = species)) +
...
#| fig-height: 3
#| fig-width: 3.5
points_on_top <- ggplot(penguins, aes(x = bill_len,
                                      y = bill_dep, 
                                      colour = species)) +
  geom_smooth() +
  geom_point()

smooth_on_top <- ggplot(penguins, aes(x = bill_len,
                                      y = bill_dep,
                                      colour = species)) +
  geom_point() +
  geom_smooth()
...
#| fig-width: 6
#| fig-alt: > 
#|   Scatterplots with a smoother. In the left plot, the points obscure the
#|   smooth line. In the right plot, the smooth line is drawn on
#|   top of the points. 
points_on_top + labs(title = "Points on top") +
  smooth_on_top + labs(title = "Smooth on top") & 
...
#| fig-height: 3
#| fig-width: 3.5
#| fig-alt: An empty plot because the geometry was forgotten.
ggplot(data = penguins, aes(x = bill_len,
                            y = bill_dep,
                            colour = species))
```
...
```{r}
#| eval: false
ggplot(penguins, aes(x = bill_len, y = bill_dep, fill = species)) +
  geom_point() +
