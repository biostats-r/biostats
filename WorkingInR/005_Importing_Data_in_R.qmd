...
You need to be working in an RStudio project.
:::
...
First make a directory called "data" within your RStudio project. 
...
Import the Mt Gonga plant biomass data in file "biomass2015_H.csv".
...
This means that if you want to replace existing names, you should also u
...
Here we can use apache arrow with the [`arrow` package](https://arrow.apache.org/docs/r/articles/dataset.html). 
This can work with `dplyr` functions to process large datasets efficiently.
