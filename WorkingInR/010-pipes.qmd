...
You can make a pipe either by typing it directly, or by using the RStudio keyboard shortcut <kbd>Ctrl</kbd> + <kbd>Shift</kbd> + <kbd>m</kbd> (on a Mac, <kbd>cmd</kbd> + <kbd>Shift</kbd> + <kbd>m</kbd>).
