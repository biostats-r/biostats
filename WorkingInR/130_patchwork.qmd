...
```{r some-plots}
p1 <- ggplot(penguins, aes(x = species, y = bill_len)) +
  geom_boxplot()
p2 <- ggplot(penguins, aes(x = body_mass, y = bill_len, colour = species)) +
  geom_point()
p3 <- ggplot(penguins, aes(x = body_mass, y = bill_len, colour = species)) +
  geom_point() +
