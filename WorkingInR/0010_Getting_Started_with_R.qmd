...
- learn why we use the [RStudio](https://rstudio.com){target="_blank"} integrated development environment for working with R
...
If you already have these installed, check that the R version is 4.2 or newer and the RStudio version is 2022.07.1 or newer.
:::
...
### What's next {.unnumbered .facta .toc-ignore}
...
### Contributors {.unnumbered .contributors .toc-ignore}
