...
A comment in an R code block starts with a `#`, just as in an ordinary script.
...
In the source editor, you can select text you want to hide and use the same keyboard short-cut to comment it out.
:::
