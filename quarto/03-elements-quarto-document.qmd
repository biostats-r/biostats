...
Make a new code block (or blocks) that make a plot showing the effect of the treatment on _Bistorta_ leaf thickness.
...
Use some inline R code to report the number of leaf thickness measurements for _Bistorta vivipera_.
