...
Sometimes it is useful to be able to write in markdown directly, rather than using the visual editor, for example if you are writing a question for [stackoverflow.com](https://stackoverflow.com) or an issue on [github.com](https://github.com).
...
**Interactive table: Click to select block options**
