...
This is a code block that loads the penguin data from the `palmerpenguins` package.
...
Use the following widget, which initially shows the defaults, to explore what is shown with the different options.

::: {style="background-color: lightgrey;  padding:5px; border: 2px solid darkgrey;"}
