...
#| fig-alt: Screenshot of RStudio showing the render button, which has a blue arrow pointing towards the word "Render".
#| out-width: "160px"
#| echo: false
...
The second rule is that is you have a "." in your name, you will confuse RStudio and it will think you have added an extension.
This means you have to add the ".qmd" yourself.
Easiest to avoid "." and use "-" or "_" to separate words in the file name.
:::
