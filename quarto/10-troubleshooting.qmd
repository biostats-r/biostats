...
- **restart from scratch**, making a new document that contains only what is needed to reproduce the problem. This is useful when you know where the problem is.
