...
We will use plant trait data from two locations on Svalbard.
One site is located close to nesting sites of sea birds receiving nutrient input while the other has no nutrient input by sea birds.
