...
3.  The function `tar_source()` will **source all the R scripts** in the environment of the pipeline.
...
-   The [target manual](https://books.ropensci.org/targets/) contains everything you need to know. There is also a large [debugging section](https://books.ropensci.org/targets/debugging.html). <!-- did not find it on github -->
