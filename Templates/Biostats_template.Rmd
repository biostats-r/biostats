...
In the second part you can add any libraries that need loading and source the file that sets the figure options (also see below).
...
```{r display-figure, echo=FALSE, fig.cap="Penguine flipper and bill length."}
...
The figures can be referd to in the text using @ref(fig:display-figure)
