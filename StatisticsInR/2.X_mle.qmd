...
p + stat_function(fun = dnorm, args = list(mean = 10, sd = 2.25), aes(col = "purple"), size = 1) +
  ...
  scale_color_identity(
    ...
    labels = c("f∼ N (10, 2.25)", "f1∼ N (10, 9)", "f2∼ N (10, 0.25)", "f3∼ N (8, 2.25)"), guide = "legend"
  ) + labs(title = "Figure 2", caption = "Data by Safa Chaabani")
```
...
ggplot(data3) +
  ...
  labs(
    title = "Figure 3", subtitle = "Number of visitors per day",
