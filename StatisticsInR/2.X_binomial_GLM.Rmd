...
natural logarithm of the odds ratio ($$\frac{p}{1-p}$$). The odds ratio
...
The $y$ is the response variable and is a single vector of numbers, usually in
the format of a factor or logical or integer. 
...
```{r response-scale-example, include = TRUE, echo = FALSE, fig.cap = "Example of a Binomial GLM model line on the scale of the response data. Intercept in orange and slope in blue", fig.height=150}
