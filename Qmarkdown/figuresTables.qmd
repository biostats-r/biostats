...
#| fig-alt: "A histogram of penguin bill lengths"
...
See the section on cross-referencing.
:::
...
Photographs and other figures that have been prepared outside of R can be included with the insert tool by typing "/" on a blank line and choosing "Figure/Image".
...
#| out-width: "491px"
#| fig-cap: "An embedded figure of a diatom"
