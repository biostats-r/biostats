...
(`trackdown` currently only works with rmd files not qmd, but I hope this will change soon).
:::
...
Type a forwards slash "/" on a blank line and choose "R code chunk".
...
In section @cross-referencing you will see how to use chunk names to cross-reference figures and tables in your document.
