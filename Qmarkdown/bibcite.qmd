...
If you type a `@` the visual editor will give suggestions from the bibliography. This is not so useful if you have many references. Alternatively, summon the import anything tool by typing "/" on a blank line and opening the citation menu, which lets you search for references in the bibliography or add new ones. You can then move the reference to where you want it.
