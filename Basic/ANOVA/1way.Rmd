...
+ [pairwise t-test with the function pairwise.t.test()](http://biostats.w.uib.no/post-hoc-tests-pairwise-comparisons/){target="_blank"} or a [Tukey HSD](http://biostats.w.uib.no/post-hoc-tests-tukey-hsd/){target="_blank"},
+ [Tukey’s Honest Significant Difference (HSD) with TukeyHSD()](https://biostats.w.uib.no/post-hoc-tests-tukey-hsd/){target="_blank"},
