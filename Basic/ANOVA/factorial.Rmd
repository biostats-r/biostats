...
Using factorial ANOVA, we get to assess **main effects**, in other words the impact of single, independent factors on a given variable (plant size, egg number, individual bodyweightâ¦). We also get to see whether there exist **interactions** between factors, i.e. whether the effect of a specific factor is influenced by (one of the) other factors.
