...
```
So, the test results in a p-value *less* than 0.05, thus indicating that the null hypothesis (the samples means are not different) may be rejected. 
