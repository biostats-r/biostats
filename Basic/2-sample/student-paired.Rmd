...
# title: comparing two proportions - Student's paired t-test
# author: jonathan
# revised: 13/1/2020 
...
```
All p-values are greater than 0.005; the samples thus have equal variances and originate from a normal distribution.
