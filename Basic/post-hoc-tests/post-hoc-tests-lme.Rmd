...
The syntax is `glht(model, linfct=mcp(predictor='Tukey'))` where `predictor` is the predictor variable which levels have to be compared pairwise. Let's apply it to our example:
```{r glht}
# fit the model
