...
The next function should work, but will generate a note in the checking stage.
as the check does not recognise `or`.
...
### Importing and exporting functions {#sec-importing-exporting-functions}
